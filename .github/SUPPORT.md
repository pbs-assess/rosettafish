# Getting help with rosettafish

Thanks for using rosettafish. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/rosettafish/issues) to make sure the 
