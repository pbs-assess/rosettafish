...
rosettafish is an R package to translate fish- and fisheries-related words or short phrases between languages (English to French or French to English).
...
2. Add the terms to the end of the file `data-raw/terms.csv` with a text editor (**not Excel!**). Ensure your editor is saving in UTF-8 format or the French accents will be destroyed. [Help with UTF-8 file encoding and RStudio](https://support.rstudio.com/hc/en-us/articles/200532197-Character-Encoding).
...
1. [Edit the file directly on GitHub](https://github.com/pbs-assess/rosettafish/edit/master/data-raw/terms.csv).
